...
public class LessonMapper {
    ...
    public static LessonDTO toDTO(Lesson entity) {
        return LessonDTO.builder()
                ...
                .offers(entity.getOffers().stream().map(LessonOfferMapper::toDTO).collect(Collectors.toSet()))
    ...
    public static Lesson toEntity(LessonDTO dto) {
        return Lesson.builder()
                ...
                .offers(dto.getOffers().stream().map(LessonOfferMapper::toEntity).collect(Collectors.toSet()))
                .active(dto.isActive())
